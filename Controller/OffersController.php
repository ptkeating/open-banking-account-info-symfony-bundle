...
use OpenAPI\Server\Model\OBReadOffer1;
...
class OffersController extends Controller
{
    ...
    /**
     * Operation getAccountsAccountIdOffers
     *
     * Get Offers
     *
     ...
     */
    public function getAccountsAccountIdOffersAction(Request $request, $accountId)
    {
        ...
        try {
            ...
            $result = $handler->getAccountsAccountIdOffers($accountId, $authorization, $xFapiAuthDate, $xFapiCustomerIpAddress, $xFapiInteractionId, $xCustomerUserAgent, $responseCode, $responseHeaders);
    ...
    public function getOffersAction(Request $request)
    {
        ...
        try {
            ...
            $result = $handler->getOffers($authorization, $xFapiAuthDate, $xFapiCustomerIpAddress, $xFapiInteractionId, $xCustomerUserAgent, $responseCode, $responseHeaders);
