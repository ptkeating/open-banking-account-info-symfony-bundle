...
use OpenAPI\Server\Model\OBReadBalance1;

/**
 * BalancesController Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Server\Controller
 * @author   OpenAPI Generator team
...
class BalancesController extends Controller
{
    ...
    /**
     * Operation getAccountsAccountIdBalances
     *
     * Get Balances
     *
     ...
     */
    public function getAccountsAccountIdBalancesAction(Request $request, $accountId)
    {
        ...
        try {
            ...
            $result = $handler->getAccountsAccountIdBalances($accountId, $authorization, $xFapiAuthDate, $xFapiCustomerIpAddress, $xFapiInteractionId, $xCustomerUserAgent, $responseCode, $responseHeaders);
    ...
    public function getBalancesAction(Request $request)
    {
        ...
        try {
            ...
            $result = $handler->getBalances($authorization, $xFapiAuthDate, $xFapiCustomerIpAddress, $xFapiInteractionId, $xCustomerUserAgent, $responseCode, $responseHeaders);
     ...
     * @return BalancesApiInterface
     */
    public function getApiHandler()
    {
        return $this->apiServer->getApiHandler('balances');
    }
}
