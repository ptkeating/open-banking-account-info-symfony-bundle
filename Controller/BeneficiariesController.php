...
use OpenAPI\Server\Model\OBReadBeneficiary5;

/**
 * BeneficiariesController Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Server\Controller
 * @author   OpenAPI Generator team
...
class BeneficiariesController extends Controller
{
    ...
    /**
     * Operation getAccountsAccountIdBeneficiaries
     *
     * Get Beneficiaries
     *
     ...
     */
    public function getAccountsAccountIdBeneficiariesAction(Request $request, $accountId)
    {
        ...
        try {
            ...
            $result = $handler->getAccountsAccountIdBeneficiaries($accountId, $authorization, $xFapiAuthDate, $xFapiCustomerIpAddress, $xFapiInteractionId, $xCustomerUserAgent, $responseCode, $responseHeaders);
    ...
    public function getBeneficiariesAction(Request $request)
    {
        ...
        try {
            ...
            $result = $handler->getBeneficiaries($authorization, $xFapiAuthDate, $xFapiCustomerIpAddress, $xFapiInteractionId, $xCustomerUserAgent, $responseCode, $responseHeaders);
     ...
     * @return BeneficiariesApiInterface
     */
    public function getApiHandler()
    {
        return $this->apiServer->getApiHandler('beneficiaries');
    }
}
