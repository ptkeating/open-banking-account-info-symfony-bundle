...
use OpenAPI\Server\Model\OBReadStandingOrder6;

/**
 * StandingOrdersController Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Server\Controller
 * @author   OpenAPI Generator team
...
class StandingOrdersController extends Controller
{
    ...
    /**
     * Operation getAccountsAccountIdStandingOrders
     *
     * Get Standing Orders
     *
     ...
     */
    public function getAccountsAccountIdStandingOrdersAction(Request $request, $accountId)
    {
        ...
        try {
            ...
            $result = $handler->getAccountsAccountIdStandingOrders($accountId, $authorization, $xFapiAuthDate, $xFapiCustomerIpAddress, $xFapiInteractionId, $xCustomerUserAgent, $responseCode, $responseHeaders);
     ...
     * @return Response The Symfony response.
     */
    public function getStandingOrdersAction(Request $request)
    {
        // Figure out what data format to return to the client
        $produces = ['application/json; charset=utf-8', 'application/json', 'application/jose+jwe'];
        // Figure out what the client accepts
        ...
        try {
            ...
            $result = $handler->getStandingOrders($authorization, $xFapiAuthDate, $xFapiCustomerIpAddress, $xFapiInteractionId, $xCustomerUserAgent, $responseCode, $responseHeaders);
     ...
     * @return StandingOrdersApiInterface
     */
    public function getApiHandler()
    {
        return $this->apiServer->getApiHandler('standingOrders');
    }
}
