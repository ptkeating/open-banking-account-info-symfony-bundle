...
class AccountsController extends Controller
{
    ...
    public function getAccountsAction(Request $request)
    {
        ...
        try {
            ...
            $result = $handler->getAccounts($authorization, $xFapiAuthDate, $xFapiCustomerIpAddress, $xFapiInteractionId, $xCustomerUserAgent, $responseCode, $responseHeaders);
     ...
     * @return Response The Symfony response.
     */
    public function getAccountsAccountIdAction(Request $request, $accountId)
    {
        // Figure out what data format to return to the client
        $produces = ['application/json; charset=utf-8', 'application/json', 'application/jose+jwe'];
        // Figure out what the client accepts
        ...
        try {
            ...
            $result = $handler->getAccountsAccountId($accountId, $authorization, $xFapiAuthDate, $xFapiCustomerIpAddress, $xFapiInteractionId, $xCustomerUserAgent, $responseCode, $responseHeaders);
