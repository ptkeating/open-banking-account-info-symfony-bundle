...
use OpenAPI\Server\Model\OBReadParty2;
use OpenAPI\Server\Model\OBReadParty3;

/**
 * PartiesController Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Server\Controller
 * @author   OpenAPI Generator team
...
class PartiesController extends Controller
{
    ...
    /**
     * Operation getAccountsAccountIdParties
     *
     * Get Parties
     *
     ...
     */
    public function getAccountsAccountIdPartiesAction(Request $request, $accountId)
    {
        ...
        try {
            ...
            $result = $handler->getAccountsAccountIdParties($accountId, $authorization, $xFapiAuthDate, $xFapiCustomerIpAddress, $xFapiInteractionId, $xCustomerUserAgent, $responseCode, $responseHeaders);
    ...
    /**
     * Operation getAccountsAccountIdParty
     *
     * Get Parties
     *
     * @param Request $request The Symfony request to handle.
     * @return Response The Symfony response.
     */
    public function getAccountsAccountIdPartyAction(Request $request, $accountId)
    {
        // Figure out what data format to return to the client
        $produces = ['application/json; charset=utf-8', 'application/json', 'application/jose+jwe'];
        // Figure out what the client accepts
        ...
        try {
            ...
            $result = $handler->getAccountsAccountIdParty($accountId, $authorization, $xFapiAuthDate, $xFapiCustomerIpAddress, $xFapiInteractionId, $xCustomerUserAgent, $responseCode, $responseHeaders);
     ...
     * @return Response The Symfony response.
     */
    public function getPartyAction(Request $request)
    {
        // Figure out what data format to return to the client
        $produces = ['application/json; charset=utf-8', 'application/json', 'application/jose+jwe'];
        // Figure out what the client accepts
        ...
        try {
            ...
            $result = $handler->getParty($authorization, $xFapiAuthDate, $xFapiCustomerIpAddress, $xFapiInteractionId, $xCustomerUserAgent, $responseCode, $responseHeaders);
     ...
     * @return PartiesApiInterface
     */
    public function getApiHandler()
    {
        return $this->apiServer->getApiHandler('parties');
    }
}
