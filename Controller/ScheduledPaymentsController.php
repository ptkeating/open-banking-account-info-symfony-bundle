...
/**
 * ScheduledPaymentsController Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Server\Controller
 * @author   OpenAPI Generator team
 * @link     https://github.com/openapitools/openapi-generator
 */
class ScheduledPaymentsController extends Controller
{
     ...
     */
    public function getAccountsAccountIdScheduledPaymentsAction(Request $request, $accountId)
    {
        ...
        try {
            ...
            $result = $handler->getAccountsAccountIdScheduledPayments($accountId, $authorization, $xFapiAuthDate, $xFapiCustomerIpAddress, $xFapiInteractionId, $xCustomerUserAgent, $responseCode, $responseHeaders);
            ...
            switch ($responseCode) {
                case 200:
                    $message = 'Scheduled Payments Read';
                    break;
                case 400:
                    $message = 'Bad request';
                    break;
     ...
     * @return Response The Symfony response.
     */
    public function getScheduledPaymentsAction(Request $request)
    {
        // Figure out what data format to return to the client
        $produces = ['application/json; charset=utf-8', 'application/json', 'application/jose+jwe'];
        // Figure out what the client accepts
        ...
        try {
            ...
            $result = $handler->getScheduledPayments($authorization, $xFapiAuthDate, $xFapiCustomerIpAddress, $xFapiInteractionId, $xCustomerUserAgent, $responseCode, $responseHeaders);
     ...
     * @return ScheduledPaymentsApiInterface
     */
    public function getApiHandler()
    {
        return $this->apiServer->getApiHandler('scheduledPayments');
    }
}
