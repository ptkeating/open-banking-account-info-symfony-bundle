...
/**
 * Class representing the TierBandInner model.
 *
 * Tier Band Details
 *
 * @package OpenAPI\Server\Model
...
class TierBandInner 
{
     ...
     * @Assert\Choice({ "Daily", "HalfYearly", "Monthly", "Other", "Quarterly", "PerStatementDate", "Weekly", "Yearly" })
     * @Assert\Type("string")
     * @Type("string")
     */
     ...
     * Sets identification.
     *
     * @param string|null $identification  Unique and unambiguous identification of a  Tier Band for a BCA.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $applicationFrequency  How often is interest applied to the BCA for this tier/band i.e. how often the financial institution pays accumulated interest to the customer's BCA.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $bankInterestRateType  Interest rate types, other than AER, which financial institutions may use to describe the annual interest rate payable to the BCA.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $bankInterestRate  Bank Interest for the BCA product
     *
     * @return $this
     */
