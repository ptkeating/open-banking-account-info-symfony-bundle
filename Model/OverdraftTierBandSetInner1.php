...
/**
 * Class representing the OverdraftTierBandSetInner1 model.
 *
...
class OverdraftTierBandSetInner1 
{
        /**
     ...
     * @Assert\NotNull()
     * @Assert\Choice({ "Tiered", "Whole", "Banded" })
     * @Assert\Type("string")
     * @Type("string")
     */
     ...
     * @Assert\Choice({ "Committed", "OnDemand", "Other" })
     * @Assert\Type("string")
     * @Type("string")
     */
     ...
     * @Assert\Valid()
     * @Assert\All({
     *   @Assert\Type("OpenAPI\Server\Model\OverdraftTierBandInner1")
     * })
     * @Type("array<OpenAPI\Server\Model\OverdraftTierBandInner1>")
     * @Assert\Count(
     *   min = 1
     * )
     */
     ...
     * @Assert\All({
     *   @Assert\Type("OpenAPI\Server\Model\OverdraftFeesChargesInner3")
     * })
     * @Type("array<OpenAPI\Server\Model\OverdraftFeesChargesInner3>")
     */
