...
/**
 * Class representing the OverdraftFeeChargeCapInner model.
 *
...
class OverdraftFeeChargeCapInner 
{
        /**
     ...
     * Sets minMaxType.
     *
     * @param string|null $minMaxType  Min Max type
     *
     * @return $this
     */
     ...
     *
     * @param float|null $feeCapOccurrence  Indicates whether the advertised overdraft rate is guaranteed to be offered to a borrower by the bank e.g. if it’s part of a government scheme, or whether the rate may vary dependent on the applicant’s circumstances.
     *
     * @return $this
     */
