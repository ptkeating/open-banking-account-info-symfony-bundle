...
/**
 * Class representing the OverdraftTierBandInner model.
 *
...
class OverdraftTierBandInner 
{
     ...
     * @Type("float")
     */
    protected ?float $agreementLengthMin = null;
     ...
     * @Type("float")
     */
    protected ?float $agreementLengthMax = null;
     ...
     * @Assert\All({
     *   @Assert\Type("OpenAPI\Server\Model\OverdraftFeesChargesInner")
     * })
     * @Type("array<OpenAPI\Server\Model\OverdraftFeesChargesInner>")
     */
     ...
     * @return float|null
     */
    public function getAgreementLengthMin(): ?float
    {
     ...
     *
     * @param float|null $agreementLengthMin  Specifies the minimum length of a band for a fixed overdraft agreement
     *
     * @return $this
     */
    public function setAgreementLengthMin(?float $agreementLengthMin = null): self
    {
     ...
     * @return float|null
     */
    public function getAgreementLengthMax(): ?float
    {
     ...
     *
     * @param float|null $agreementLengthMax  Specifies the maximum length of a band for a fixed overdraft agreement
     *
     * @return $this
     */
    public function setAgreementLengthMax(?float $agreementLengthMax = null): self
    {
