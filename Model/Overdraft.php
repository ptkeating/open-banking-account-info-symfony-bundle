...
/**
 * Class representing the Overdraft model.
 *
 * Borrowing details
 *
 * @package OpenAPI\Server\Model
...
class Overdraft 
{
     ...
     * @Assert\Valid()
     * @Assert\All({
     *   @Assert\Type("OpenAPI\Server\Model\OverdraftTierBandSetInner")
     * })
     * @Type("array<OpenAPI\Server\Model\OverdraftTierBandSetInner>")
     * @Assert\Count(
     *   min = 1
     * )
     */
