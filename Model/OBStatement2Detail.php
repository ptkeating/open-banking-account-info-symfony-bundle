...
/**
 * Class representing the OBStatement2Detail model.
 *
...
class OBStatement2Detail 
{
     ...
     * @Assert\All({
     *   @Assert\Type("OpenAPI\Server\Model\OBStatement2DetailStatementAmountInner")
     * })
     * @Type("array<OpenAPI\Server\Model\OBStatement2DetailStatementAmountInner>")
     */
