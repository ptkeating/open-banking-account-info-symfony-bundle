...
/**
 * Class representing the OBReadProduct2 model.
 *
...
{
        /**
     * @var OBReadProduct2Data|null
     * @SerializedName("Data")
     * @Assert\NotNull()
     * @Assert\Valid()
     * @Assert\Type("OpenAPI\Server\Model\OBReadProduct2Data")
     * @Type("OpenAPI\Server\Model\OBReadProduct2Data")
     */
    protected ?OBReadProduct2Data $data = null;
     ...
     * Gets data.
     *
     * @return OBReadProduct2Data|null
     */
    public function getData(): ?OBReadProduct2Data
    {
        return $this->data;
    }
     ...
     * Sets data.
     *
     * @param OBReadProduct2Data|null $data
     *
     * @return $this
     */
    public function setData(?OBReadProduct2Data $data): self
    {
        $this->data = $data;
