...
/**
 * Class representing the TierBandSetInner model.
 *
...
class TierBandSetInner 
{
     ...
     * @Assert\Valid()
     * @Assert\All({
     *   @Assert\Type("OpenAPI\Server\Model\TierBandInner")
     * })
     * @Type("array<OpenAPI\Server\Model\TierBandInner>")
     * @Assert\Count(
     *   min = 1
     * )
     */
