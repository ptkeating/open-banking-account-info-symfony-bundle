...
/**
 * TierBandSetInner1Test Class Doc Comment
 *
 * @category    Class
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\TierBandSetInner1
 */
class TierBandSetInner1Test extends TestCase
{
    protected TierBandSetInner1|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(TierBandSetInner1::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(TierBandSetInner1::class));
        $this->assertInstanceOf(TierBandSetInner1::class, $this->object);
    }
