<?php
/**
 * OBReadProduct2DataProductInnerOtherProductTypeOtherFeesChargesInnerFeeChargeDetailInnerTest
 *
 * PHP version 8.1.1
 *
 * @category Class
...
/**
 * OBReadProduct2DataProductInnerOtherProductTypeOtherFeesChargesInnerFeeChargeDetailInnerTest Class Doc Comment
 *
 * @category    Class
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\OBReadProduct2DataProductInnerOtherProductTypeOtherFeesChargesInnerFeeChargeDetailInner
 */
class OBReadProduct2DataProductInnerOtherProductTypeOtherFeesChargesInnerFeeChargeDetailInnerTest extends TestCase
{
    protected OBReadProduct2DataProductInnerOtherProductTypeOtherFeesChargesInnerFeeChargeDetailInner|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(OBReadProduct2DataProductInnerOtherProductTypeOtherFeesChargesInnerFeeChargeDetailInner::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(OBReadProduct2DataProductInnerOtherProductTypeOtherFeesChargesInnerFeeChargeDetailInner::class));
        $this->assertInstanceOf(OBReadProduct2DataProductInnerOtherProductTypeOtherFeesChargesInnerFeeChargeDetailInner::class, $this->object);
    }
    ...
    /**
     * Test attribute "otherFeeCategoryType"
     *
     * @group unit
     * @small
     */
    public function testPropertyOtherFeeCategoryType(): void
    {
        $this->markTestSkipped('Test for property otherFeeCategoryType not implemented');
    }
    ...
    /**
     * Test attribute "feeApplicableRange"
     *
     * @group unit
     * @small
     */
    public function testPropertyFeeApplicableRange(): void
    {
        $this->markTestSkipped('Test for property feeApplicableRange not implemented');
    }
}
