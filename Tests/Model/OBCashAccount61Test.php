...
/**
 * OBCashAccount61Test Class Doc Comment
 *
 * @category    Class
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\OBCashAccount61
 */
class OBCashAccount61Test extends TestCase
{
    protected OBCashAccount61|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(OBCashAccount61::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(OBCashAccount61::class));
        $this->assertInstanceOf(OBCashAccount61::class, $this->object);
    }
