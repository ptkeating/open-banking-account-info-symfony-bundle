...
/**
 * OverdraftFeeChargeCapTest Class Doc Comment
 *
 * @category    Class
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\OverdraftFeeChargeCap
 */
class OverdraftFeeChargeCapTest extends TestCase
{
    protected OverdraftFeeChargeCap|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(OverdraftFeeChargeCap::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(OverdraftFeeChargeCap::class));
        $this->assertInstanceOf(OverdraftFeeChargeCap::class, $this->object);
    }
