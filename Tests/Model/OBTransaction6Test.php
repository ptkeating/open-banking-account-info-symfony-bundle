...
/**
 * OBTransaction6Test Class Doc Comment
 *
 * @category    Class
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\OBTransaction6
 */
class OBTransaction6Test extends TestCase
{
    protected OBTransaction6|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(OBTransaction6::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(OBTransaction6::class));
        $this->assertInstanceOf(OBTransaction6::class, $this->object);
    }
