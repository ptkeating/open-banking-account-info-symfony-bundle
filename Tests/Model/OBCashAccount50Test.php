...
/**
 * OBCashAccount50Test Class Doc Comment
 *
 * @category    Class
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\OBCashAccount50
 */
class OBCashAccount50Test extends TestCase
{
    protected OBCashAccount50|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(OBCashAccount50::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(OBCashAccount50::class));
        $this->assertInstanceOf(OBCashAccount50::class, $this->object);
    }
