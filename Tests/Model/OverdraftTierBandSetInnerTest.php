...
/**
 * OverdraftTierBandSetInnerTest Class Doc Comment
 *
 * @category    Class
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\OverdraftTierBandSetInner
 */
class OverdraftTierBandSetInnerTest extends TestCase
{
    protected OverdraftTierBandSetInner|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(OverdraftTierBandSetInner::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(OverdraftTierBandSetInner::class));
        $this->assertInstanceOf(OverdraftTierBandSetInner::class, $this->object);
    }
