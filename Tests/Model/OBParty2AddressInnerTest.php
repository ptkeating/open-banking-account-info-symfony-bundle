...
/**
 * OBParty2AddressInnerTest Class Doc Comment
 *
 * @category    Class
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\OBParty2AddressInner
 */
class OBParty2AddressInnerTest extends TestCase
{
    protected OBParty2AddressInner|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(OBParty2AddressInner::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(OBParty2AddressInner::class));
        $this->assertInstanceOf(OBParty2AddressInner::class, $this->object);
    }
