<?php
/**
 * OverdraftFeeChargeCapInnerTest
 *
 * PHP version 8.1.1
 *
 * @category Class
...
/**
 * OverdraftFeeChargeCapInnerTest Class Doc Comment
 *
 * @category    Class
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\OverdraftFeeChargeCapInner
 */
class OverdraftFeeChargeCapInnerTest extends TestCase
{
    protected OverdraftFeeChargeCapInner|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(OverdraftFeeChargeCapInner::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(OverdraftFeeChargeCapInner::class));
        $this->assertInstanceOf(OverdraftFeeChargeCapInner::class, $this->object);
    }
