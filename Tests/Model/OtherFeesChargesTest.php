...
/**
 * OtherFeesChargesTest Class Doc Comment
 *
 * @category    Class
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\OtherFeesCharges
 */
class OtherFeesChargesTest extends TestCase
{
    protected OtherFeesCharges|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(OtherFeesCharges::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(OtherFeesCharges::class));
        $this->assertInstanceOf(OtherFeesCharges::class, $this->object);
    }
