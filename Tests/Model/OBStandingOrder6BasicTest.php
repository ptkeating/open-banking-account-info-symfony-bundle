...
/**
 * OBStandingOrder6BasicTest Class Doc Comment
 *
 * @category    Class
 * @description OBStandingOrder6Basic
 * @package     OpenAPI\Server\Tests\Model
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\OBStandingOrder6Basic
 */
class OBStandingOrder6BasicTest extends TestCase
{
    protected OBStandingOrder6Basic|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(OBStandingOrder6Basic::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(OBStandingOrder6Basic::class));
        $this->assertInstanceOf(OBStandingOrder6Basic::class, $this->object);
    }
