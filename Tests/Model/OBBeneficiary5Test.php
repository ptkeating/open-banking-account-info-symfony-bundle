...
/**
 * OBBeneficiary5Test Class Doc Comment
 *
 * @category    Class
 * @description OBBeneficiary5
 * @package     OpenAPI\Server\Tests\Model
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\OBBeneficiary5
 */
class OBBeneficiary5Test extends TestCase
{
    protected OBBeneficiary5|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(OBBeneficiary5::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(OBBeneficiary5::class));
        $this->assertInstanceOf(OBBeneficiary5::class, $this->object);
    }
