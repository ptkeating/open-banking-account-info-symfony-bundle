...
/**
 * OBStandingOrder6Test Class Doc Comment
 *
 * @category    Class
 * @description OBStandingOrder6
 * @package     OpenAPI\Server\Tests\Model
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\OBStandingOrder6
 */
class OBStandingOrder6Test extends TestCase
{
    protected OBStandingOrder6|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(OBStandingOrder6::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(OBStandingOrder6::class));
        $this->assertInstanceOf(OBStandingOrder6::class, $this->object);
    }
