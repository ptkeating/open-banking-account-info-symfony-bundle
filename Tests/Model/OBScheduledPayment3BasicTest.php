...
/**
 * OBScheduledPayment3BasicTest Class Doc Comment
 *
 * @category    Class
 * @description OBScheduledPayment3Basic
 * @package     OpenAPI\Server\Tests\Model
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\OBScheduledPayment3Basic
 */
class OBScheduledPayment3BasicTest extends TestCase
{
    protected OBScheduledPayment3Basic|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(OBScheduledPayment3Basic::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(OBScheduledPayment3Basic::class));
        $this->assertInstanceOf(OBScheduledPayment3Basic::class, $this->object);
    }
