<?php
/**
 * OverdraftFeeChargeDetailInnerTest
 *
 * PHP version 8.1.1
 *
 * @category Class
...
/**
 * OverdraftFeeChargeDetailInnerTest Class Doc Comment
 *
 * @category    Class
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\OverdraftFeeChargeDetailInner
 */
class OverdraftFeeChargeDetailInnerTest extends TestCase
{
    protected OverdraftFeeChargeDetailInner|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(OverdraftFeeChargeDetailInner::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(OverdraftFeeChargeDetailInner::class));
        $this->assertInstanceOf(OverdraftFeeChargeDetailInner::class, $this->object);
    }
