...
/**
 * OtherFeeType1Test Class Doc Comment
 *
 * @category    Class
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\OtherFeeType1
 */
class OtherFeeType1Test extends TestCase
{
    protected OtherFeeType1|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(OtherFeeType1::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(OtherFeeType1::class));
        $this->assertInstanceOf(OtherFeeType1::class, $this->object);
    }
