...
/**
 * FeeChargeDetailInnerTest Class Doc Comment
 *
 * @category    Class
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\FeeChargeDetailInner
 */
class FeeChargeDetailInnerTest extends TestCase
{
    protected FeeChargeDetailInner|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(FeeChargeDetailInner::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(FeeChargeDetailInner::class));
        $this->assertInstanceOf(FeeChargeDetailInner::class, $this->object);
    }
