...
/**
 * OBReadProduct2Test Class Doc Comment
 *
 * @category    Class
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\OBReadProduct2
 */
class OBReadProduct2Test extends TestCase
{
    protected OBReadProduct2|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(OBReadProduct2::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(OBReadProduct2::class));
        $this->assertInstanceOf(OBReadProduct2::class, $this->object);
    }
