...
/**
 * FeeChargeCapInnerTest Class Doc Comment
 *
 * @category    Class
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\FeeChargeCapInner
 */
class FeeChargeCapInnerTest extends TestCase
{
    protected FeeChargeCapInner|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(FeeChargeCapInner::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(FeeChargeCapInner::class));
        $this->assertInstanceOf(FeeChargeCapInner::class, $this->object);
    }
