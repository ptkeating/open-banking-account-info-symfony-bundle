...
/**
 * OBScheduledPayment3Test Class Doc Comment
 *
 * @category    Class
 * @description OBScheduledPayment3
 * @package     OpenAPI\Server\Tests\Model
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\OBScheduledPayment3
 */
class OBScheduledPayment3Test extends TestCase
{
    protected OBScheduledPayment3|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(OBScheduledPayment3::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(OBScheduledPayment3::class));
        $this->assertInstanceOf(OBScheduledPayment3::class, $this->object);
    }
