...
/**
 * FeeChargeDetailInner1Test Class Doc Comment
 *
 * @category    Class
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\FeeChargeDetailInner1
 */
class FeeChargeDetailInner1Test extends TestCase
{
    protected FeeChargeDetailInner1|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(FeeChargeDetailInner1::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(FeeChargeDetailInner1::class));
        $this->assertInstanceOf(FeeChargeDetailInner1::class, $this->object);
    }
