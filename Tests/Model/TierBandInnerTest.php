...
/**
 * TierBandInnerTest Class Doc Comment
 *
 * @category    Class
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\TierBandInner
 */
class TierBandInnerTest extends TestCase
{
    protected TierBandInner|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(TierBandInner::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(TierBandInner::class));
        $this->assertInstanceOf(TierBandInner::class, $this->object);
    }
