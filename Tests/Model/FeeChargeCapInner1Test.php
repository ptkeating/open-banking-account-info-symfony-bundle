...
/**
 * FeeChargeCapInner1Test Class Doc Comment
 *
 * @category    Class
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\FeeChargeCapInner1
 */
class FeeChargeCapInner1Test extends TestCase
{
    protected FeeChargeCapInner1|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(FeeChargeCapInner1::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(FeeChargeCapInner1::class));
        $this->assertInstanceOf(FeeChargeCapInner1::class, $this->object);
    }
