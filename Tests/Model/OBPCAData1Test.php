...
/**
 * OBPCAData1Test Class Doc Comment
 *
 * @category    Class
 * @description OBPCAData1
 * @package     OpenAPI\Server\Tests\Model
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\OBPCAData1
 */
class OBPCAData1Test extends TestCase
{
    protected OBPCAData1|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(OBPCAData1::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(OBPCAData1::class));
        $this->assertInstanceOf(OBPCAData1::class, $this->object);
    }
