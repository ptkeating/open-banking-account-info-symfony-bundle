...
/**
 * OtherFeesChargesInnerTest Class Doc Comment
 *
 * @category    Class
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\OtherFeesChargesInner
 */
class OtherFeesChargesInnerTest extends TestCase
{
    protected OtherFeesChargesInner|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(OtherFeesChargesInner::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(OtherFeesChargesInner::class));
        $this->assertInstanceOf(OtherFeesChargesInner::class, $this->object);
    }
