...
/**
 * TransactionsApiInterface Interface Doc Comment
 *
 * @category Interface
...
interface TransactionsApiInterface
{
     ...
     * @param  string|null $xFapiInteractionId  An RFC4122 UID used as a correlation id. (optional)
     * @param  string|null $xCustomerUserAgent  Indicates the user-agent that the PSU is using. (optional)
     * @param  \DateTime|null $fromBookingDateTime  The UTC ISO 8601 Date Time to filter transactions FROM NB Time component is optional - set to 00:00:00 for just Date. If the Date Time contains a timezone, the ASPSP must ignore the timezone component. (optional)
     * @param  \DateTime|null $toBookingDateTime  The UTC ISO 8601 Date Time to filter transactions TO NB Time component is optional - set to 00:00:00 for just Date. If the Date Time contains a timezone, the ASPSP must ignore the timezone component. (optional)
     * @param  int     &$responseCode    The HTTP Response Code
     * @param  array   $responseHeaders  Additional HTTP headers to return with the response ()
     *
     * @return array|object|null
