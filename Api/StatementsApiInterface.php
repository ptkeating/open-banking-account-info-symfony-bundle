...
/**
 * StatementsApiInterface Interface Doc Comment
 *
 * @category Interface
 ...
 * @link     https://github.com/openapitools/openapi-generator
 */
interface StatementsApiInterface
{
     ...
     * @param  \DateTime|null $fromStatementDateTime  The UTC ISO 8601 Date Time to filter statements FROM NB Time component is optional - set to 00:00:00 for just Date. If the Date Time contains a timezone, the ASPSP must ignore the timezone component. (optional)
     * @param  \DateTime|null $toStatementDateTime  The UTC ISO 8601 Date Time to filter statements TO NB Time component is optional - set to 00:00:00 for just Date. If the Date Time contains a timezone, the ASPSP must ignore the timezone component. (optional)
